$(function () {
    ...
    function LavEnGrundnodeBoks(e) {
        ...
        if (document.getElementsByClassName("redbox")[0] = undefined) {
            console.log("der er ingen redboxes i vinduet")
    ...
    function LavEnTaleboblePil(ParentNode, NytPTag, FraNoden, MarknodenDenKommerFra) {
        ...
        var svghtml = "<svg><polyline id='pilTilMark" + MarknodenDenKommerFra.MarkNodensID +"' class='pil' points=''/></svg>"
        ...
        var placeringAfPileBen1 = parseInt(uddybning.width / 4) + "," + parseInt(21) //Først sæt: x,y for tekstboks overkant
        var placeringAfPileSpids = parseInt(markering.x + (markering.width / 2)) + "," + parseInt(-20) //Andet sæt: x,y for mark-tag
        var placeringAfPileBen2 = parseInt(uddybning.width / 3) + "," + parseInt(21) //Tredje sæt: x,y for tekstboks overkant
        //Placering af taleboblepilens to ben og spids
        pil.setAttributeNS(null, "points", placeringAfPileBen1 + " " + placeringAfPileSpids + " " +    placeringAfPileBen2);
